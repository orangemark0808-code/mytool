...
このリポジトリでは、トップページはツール一覧として公開し、PROMPT-STOCK本体は以下のURLで公開します。

- `https://orangemark0808-code.github.io/mytool/`
- `https://orangemark0808-code.github.io/mytool/PROMPT_STOCK/`

PROMPT-STOCK本体を `/mytool/PROMPT_STOCK/` で開いたときに同期できるように、GitHub Actionsは以下の2か所へ `firebase-config.js` を生成します。
